...
int main() {
  ...
  //\Gamma(m)(p=0.1,eps=0.05)
  Gamma[0]=0; Gamma[1]=1; Gamma[2]=1; Gamma[3]=1; Gamma[4]=2;
  Gamma[5]=2; Gamma[6]=2; Gamma[7]=2; Gamma[8]=2; Gamma[9]=3;
  Gamma[10]=3; Gamma[11]=3; Gamma[12]=3;
...
for(i=0;i<N;i++){
  ...
  for(i=0;i<N;i++){
    ...
    for(j=0;j<N;j++){
      x_ij_m[i][j]=IloNumVarArray(env,N*(N-1)+1);
      for(m=0;m<N*(N-1)+1;m++){
        if(i==j){
  ...
  for(i=0;i<N;i++){
    ...
    for(j=0;j<N;j++){
      y_ij_m[i][j]=IloNumVarArray(env,N*(N-1)+1);
      for(m=0;m<N*(N-1)+1;m++){
        if(i==j){
